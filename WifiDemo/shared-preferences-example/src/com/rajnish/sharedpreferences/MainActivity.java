...
package com.rajnish.sharedpreferences;
...
public class MainActivity extends Activity implements OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.save_button:
                SavePreferences("PrefDemo123", mInputEditText.getText().toString());
    ...
    {
         sharedPreferences = getSharedPreferences("PrefDemo123",MODE_PRIVATE);
